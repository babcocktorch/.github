...
|---|---|
| `babcocktorch.com` | Main publication website for news and opinions |
| `communities` | Communities at Babcock directory |
| `vendors` | Vendors at Babcock directory |
| `alumni` | Alumni at Babcock directory |
| `gallery` | The Gallery of Everything Babcock |
| `map` | The Great Map of Babcock |
| `calendar` | Communities at Babcock directory |
| `torch-cms` | Content management tooling |
| `torch-internal` | Internal ops and editorial tooling |
...
The Torch is not an open-source project in the conventional sense. Code contributions are managed through the Technology & Product team.

If you're a Babcock student interested in joining:
